...
from .config import BOT_TOKEN, REDIS_HOST, REDIS_PORT, REDIS_DB, DB_HOST, DB_PORT, DB_NAME, DB_COLLECTION_NAME
...
motor_client = AsyncIOMotorClient(DB_HOST, int(DB_PORT))
