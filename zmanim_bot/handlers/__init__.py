...
def register_handlers():
    # errors
    dp.register_errors_handler(errors.empty_exception_handler, exception=e.UnsupportedChatTypeException)
    ...
    dp.register_message_handler(menus.handle_donate, commands=['donate'])
