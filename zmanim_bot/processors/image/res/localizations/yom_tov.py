"""
This template may works with Rosh ha-shana, shavuos
"""
...
def get_translate(data: dict, _: Callable, holiday_name: str) -> GenericYomTov:
    """
    input data schema:
    {
        'year': int,
    ...
    """
    titles = {'rosh_hashana': _('ROSH HASHANA'), 'shavuos': _('SHAVUOS')}
    title = titles.get(holiday_name)
    hv_header = _('Havdala')
    shabbos = _('shabbos')
